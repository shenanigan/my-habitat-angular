  ...
  constructor(
    ...
    this.matIconRegistry.addSvgIcon(
      ...
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/images/ic_sendmessage.svg'
      )
    );
    this.matIconRegistry.addSvgIcon(
      'chat_attach',
    ...
    this.matIconRegistry.addSvgIcon(
      'default_camera',
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/images/ic_defaultcamera.svg'
      )
    );
    this.matIconRegistry.addSvgIcon(
      'member_add_success',
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/images/image_successful.svg'
      )
    );
    ...
    this.matIconRegistry.addSvgIcon(
      'call_visitor',
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/images/ic_call_visitor.svg'
      )
    );
    this.matIconRegistry.addSvgIcon(
      'call_chat',
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/images/ic_call_chat.svg'
      )
    );
    this.matIconRegistry.addSvgIcon(
      'video_chat',
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/images/ic_video_chat.svg'
      )
    );
    this.matIconRegistry.addSvgIcon(
      'back',
    ...
    this.matIconRegistry.addSvgIcon(
      'tab_profile',
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/images/tabicon_profile.svg'
      )
    );
  }
