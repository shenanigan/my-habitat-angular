...
import { messageRecieved, noticeAdded, paymentRequested } from '../../+state/shared.actions';
...
export class AblyEvents implements IRealTimeService {
    ...
    options: Ably.Types.ClientOptions = { key: 'm2BStQ.WYEoaw:WRC5iiG2PcIyhJW1fXTV-jGVlsINETMflLHfuOGexGk', closeOnUnload: true };
